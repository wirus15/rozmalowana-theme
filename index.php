            ...
            <?php for ($p = 1; $p < 5; $p++) { ?>
                ...
                <?php } else { ?>
                    <div class="listpages">
                        <a href="">
                            <div class="image">
                                <img src="<?php echo get_template_directory_uri(); ?>/images/about<?php echo $p; ?>.jpg" alt=""/>
                            </div>
                            <h4><?php _e('Page Title', 'skt-girlie'); ?><?php echo $p; ?></h4>
                        </a>
            ...
            <div class="site-main">
                ...
                <?php while ($postquery->have_posts()) : $postquery->the_post(); ?><?php $p++; ?>
                    <div class="blog_lists BlogPosts <?php if ($p % 3 == 0) { ?>last_column<?php } ?>">
                        ...
                        <a class="MoreLink"
                           href="<?php the_permalink(); ?>"><?php _e('Read more &raquo;', 'skt-girlie'); ?></a>
