    ...
    <div class="header-inner">
        <div class="logo">
            <a href="<?php echo esc_url(home_url('/')); ?>">
                <img src="<?php echo get_template_directory_uri(); ?>/images/rozmalowana_logo.png" alt="Rozmalowana - LOGO"/>
            </a>
        </div><!-- logo -->
        <div class="toggle">
        ...
        if ($slAr > 0) {
            ...
            <div class="slider-wrapper theme-default">
                <div id="slider" class="nivoSlider">
                    <?php
                    foreach ($slAr as $sv) {
                        $n++; ?><img src="<?php echo esc_url($sv['image_src']); ?>"
                                     alt="<?php echo esc_attr($sv['image_title']); ?>"
                                     title="<?php echo esc_attr('#slidecaption' . $n); ?>" /><?php
                        $slideno[] = $n;
                    }
                    ?>
                </div><?php
                ...
                <div id="slidecaption<?php echo $sln; ?>" class="nivo-html-caption">
                    <div class="slide_info">
                        <h2>
                            <a href="<?php echo esc_url(get_theme_mod('slide_link' . $sln, '#link' . $sln)); ?>"><?php echo get_theme_mod('slide_title' . $sln, 'Living and Lifestyle Title'); ?></a>
                        </h2>
                        ...
                        <?php if (get_theme_mod('slide_link' . $sln, '')) { ?>
                            <a class="morelink"
                               href="<?php echo esc_url(get_theme_mod('slide_link' . $sln, '' . $sln)); ?>"><?php _e('Read More', 'skt-girlie'); ?></a>
                        <?php } ?>
                    </div>
                    </div><?php
                } ?>
        ...
        if ($slAr > 0) {
            ...
            <div class="slider-wrapper theme-default">
                ...
                <div id="slidecaption<?php echo $sln; ?>" class="nivo-html-caption">
                    <div class="slide_info">
                        <h2>
                            <a href="<?php echo esc_url(get_theme_mod('slide_link' . $sln, '#link' . $sln)); ?>"><?php echo get_theme_mod('slide_title' . $sln, 'Splendid Days'); ?></a>
                        </h2>
                        <?php if (get_theme_mod('slide_desc' . $sln, '')) { ?>
                            <p><?php echo get_theme_mod('slide_desc' . $sln, ''); ?></p>
                        <?php } ?>
